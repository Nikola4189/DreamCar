...
require_once 'BASE/db.php';
    ...
    $id = $_GET['updateid']; // id se salje klikom na dugme update na stranici za uredjivanje tako sto se u bloku dugmeta napise <a href= "update.php?updateid = <?php echo $id ">
    ...
    if(isset($_POST['submit'])){
        ...
        // Verifikacija ekstenzije slike
            ...
            if(in_array($fileType, $allowTypes)){ 
                ...
                $update   =  "UPDATE used_car.`article` SET
                    title ='$title',
                    description = '$description',
                    mark   = '$mark',
                    model  = '$model',
                    fuel = '$fuel',
                    y_manufacture = '$y_manufacture',
                    price = '$price',
                    image_path = '$targetFilePath',
                    categiry_id = '$categiry_id' WHERE article_id = '$id'";
