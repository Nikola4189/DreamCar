<?php
    ...
    $query = "SELECT * FROM `used_car`.`article` WHERE is_sell = '1'";
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="col-lg-4">SLIKA</th>
              ...
              <?php foreach($artcles as $article): 
                  ...
                  isset($article["categiry_id"]) ? $categiry_id = $categiry_name = match ($article["categiry_id"]) {
                    "1" => "Sedan",
                    "2" => "SUV",
                    "3" => "Kupe",
                    "4" => "Karavan",
